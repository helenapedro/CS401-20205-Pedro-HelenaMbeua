...
import lesson11.labs.prob1.business.*;
...
public class TestData {
	...
	public List<Author> allAuthors = new ArrayList<Author>() {
		{
			add(new Author("Joe", "Thomas", "641-445-2123", addresses.get(0), "before.A happy man is he."));
			add(new Author("Sandra", "Thomas", "641-445-2123", addresses.get(0), "before.A happy wife is she."));
